...
namespace FFStudio
{
	public class ShakeRotationTweenData : TweenData
	{
#region Fields
	[ Title( "Shake Rotation Tween" ) ]
...
#region API
		...
		{
			recycledTween.Recycle( transform.DOShakeRotation( duration, strength, vibrato, randomness, fadeOut ),
								   unityEvent_onCompleteEvent.Invoke ) ;

#if UNITY_EDITOR
			recycledTween.Tween.SetId( "_ff_shake_rotation_tween___" + description );
#endif
